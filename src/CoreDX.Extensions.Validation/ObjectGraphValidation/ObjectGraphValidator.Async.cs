...
public static partial class ObjectGraphValidator
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return TryValidatePropertyAsync(
            value,
            validationContext,
            validationResults,
            predicate,
    ...
    public static async ValueTask ValidatePropertyAsync(
        ...
        ValidationContext validationContext,
        CancellationToken cancellationToken = default)
        => await TryValidatePropertyAsync(
            value,
            validationContext,
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (instance is IAsyncEnumerable<object?> asyncEnumerable)
        {
            ...
            {
                index++;
                var innerIsValid = await TryValidateEnumerableElementAsync(
                    instance,
                    validationContext,
                    validationResults,
                    validateAllProperties,
    ...
    private static async ValueTask<bool> TryValidateEnumerableElementAsync(
        object instance,
        ValidationContext validationContext,
        ValidationResultStore? validationResults,
        bool validateAllProperties,
